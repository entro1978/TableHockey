        ...
        <div style="border-style: solid; border-width: medium; border-color: White">
            <div style="font-weight: bold; font-size: larger;">
                <asp:GridView ID="GridViewEndGameOverview" runat="server" AutoGenerateColumns="false"
                    DataKeyNames="GameId" OnRowDataBound="GridViewEndGameOverview_RowDataBound">
                    <Columns>
                         <asp:TemplateField>
                            <ItemTemplate>
                                   <asp:DropDownList ID="DropDownListHomePlayer" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownListHomePlayer_SelectedIndexChanged">
                                   </asp:DropDownList>
                                </ItemTemplate>
                             </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="PlayerDivider" HeaderText="" />
                         <asp:TemplateField>
                            <ItemTemplate>
                                   <asp:DropDownList ID="DropDownListAwayPlayer" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownListAwayPlayer_SelectedIndexChanged">
                                   </asp:DropDownList>
                                </ItemTemplate>
                             </asp:TemplateField>                  
